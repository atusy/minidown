...
To preview them, use AI at the top of this page.
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.getElementById("button-go").addEventListener("click", function() {
    ...
    styleHiToC.innerText = `#TOC a.highlight{display:inline-block;width:100%;color:${getBGColor(anchor)};background-color:${window.getComputedStyle(anchor).color}`;
  })
});
```
